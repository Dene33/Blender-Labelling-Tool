...
def export(self, arm, frame_start, frame_end, txt_path, class_id):
    try:
        ...
        for frame in range(frame_start, frame_end + 1):
            ...
            # # pascal_voc
            # print(f"x_min:{bones_coords['top_left'][0]}", f"y_min:{bones_coords['top_left'][1]}",f"x_max:{bones_coords['bottom_right'][0]}", f"y_max:{bones_coords['bottom_right'][1]}")

            # # coco
            # width = bones_coords['top_right'][0] - bones_coords['top_left'][0]
            # height = bones_coords['bottom_left'][1] - bones_coords['top_left'][1]
            # print(f"x_min:{bones_coords['top_left'][0]}", f"y_min:{bones_coords['top_left'][1]}",f"width:{width}", f"height:{height}")
